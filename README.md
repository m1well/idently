...
- `POST /token/short` – login with code in header, get a short valid JWT
- `POST /token/long` – login with code in header, get a long valid JWT
- `GET /token/verify` – verify JWT & return claims
