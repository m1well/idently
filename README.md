...
- `GET /token/short` – login with code & audience in header, get a short valid
  JWT
- `GET /token/long` – login with code & audience in header, get a long valid JWT
- `GET /token/verify` – verify JWT (with audience header!) & return claims
